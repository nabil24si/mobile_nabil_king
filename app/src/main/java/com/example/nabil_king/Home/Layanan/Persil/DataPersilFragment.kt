...
// Tetap pakai binding layout yang sama
    ...
    private fun generateDummyData(): List<PersilModel> {
        ...
        list.add(
            PersilModel(
                ...
                "Perkebunan - Blok 041", "Dk. Hasanuddin No. 226, Jambi 30442, DKI", "0010 / 003",
                android.R.drawable.ic_menu_report_image, android.R.drawable.ic_menu_gallery
        )
        )
        // 6
        ...
        list.add(
            PersilModel(
                ...
                "Hutan Lindung - Blok 043", "Psr. Kebangkitan Nasional No. 715, Dumai 55831, Jabar", "0010 / 002",
                android.R.drawable.ic_menu_report_image, android.R.drawable.ic_menu_gallery
        )
        )
        // 9
